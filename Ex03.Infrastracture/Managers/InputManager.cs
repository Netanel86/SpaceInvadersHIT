namespace Ex03.Infrastracture.Managers
{
    ...
    public class InputManager : GameService, IInputManager
    {
        ...
        {
            return this.MouseState.X > i_RegionBounds.X
                && this.MouseState.X < i_RegionBounds.X + i_RegionBounds.Width
                && this.MouseState.Y > i_RegionBounds.Y
                && this.MouseState.Y < i_RegionBounds.Y + i_RegionBounds.Height;
        }
