...
namespace Ex03.Infrastracture.ObjectModel.Animators
{
    public class CompositeAnimator : SpriteAnimator
    {
        ...
        public bool Empty 
        {
            get { return m_AnimationsList.Count == 0 ? true : false; } 
        }
        ...
        public void Add(SpriteAnimator i_Animation)
        {
            ...
            i_Animation.Finished += new EventHandler(animator_Finished);
        ...
        private void animator_Finished(object i_Sender, EventArgs i_Args)
        {
            bool allFinished = true;
            foreach (SpriteAnimator animator in m_AnimationsList)
            {
